...
map.getView().fit([-8613738.960811, -1390793.072106, -8436176.996200, -1328760.062873], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Provincias de Lima</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (89 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para el curso de Topografía<br />UPN-2025-1<br />Brisa Delfina Garcia Silva';
            }
